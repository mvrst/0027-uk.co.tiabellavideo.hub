...
class S05cPortfolioPostPage extends StatelessWidget {
  const S05cPortfolioPostPage({super.key});
  ...
  Widget _chips(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          _c(context, const ValueKey('TK_S05C_CHIP_ALL'), 'All', RoutePaths.portfolio),
          _c(context, const ValueKey('TK_S05C_CHIP_PRODUCTION'), 'Production', RoutePaths.portfolioProduction),
          _c(context, const ValueKey('TK_S05C_CHIP_POST'), 'Post-Production', RoutePaths.portfolioPostProduction, sel: true),
          _c(context, const ValueKey('TK_S05C_CHIP_CORPORATE'), 'Corporate', RoutePaths.portfolioCorporate),
        ],
      ),
    );
  }
