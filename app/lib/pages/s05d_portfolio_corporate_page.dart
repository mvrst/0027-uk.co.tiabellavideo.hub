...
class S05dPortfolioCorporatePage extends StatelessWidget {
  const S05dPortfolioCorporatePage({super.key});
  ...
  Widget _chips(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          _c(context, const ValueKey('TK_S05D_CHIP_ALL'), 'All', RoutePaths.portfolio),
          _c(context, const ValueKey('TK_S05D_CHIP_PRODUCTION'), 'Production', RoutePaths.portfolioProduction),
          _c(context, const ValueKey('TK_S05D_CHIP_POST'), 'Post-Production', RoutePaths.portfolioPostProduction),
          _c(context, const ValueKey('TK_S05D_CHIP_CORPORATE'), 'Corporate', RoutePaths.portfolioCorporate, sel: true),
        ],
      ),
    );
  }
